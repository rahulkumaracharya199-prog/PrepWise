    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center py-24">
                ...
                {/* Right Visual */}
                <div className="bg-white rounded-3xl p-6 shadow-sm border w-full">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm font-semibold text-gray-600">Dashboard Preview</p>
                            <p className="text-xs text-gray-400">Track progress & practice stats</p>
                        </div>
                        <div className="text-xs text-gray-500">3 min demo</div>
                    </div>
            ...
            {/* CTA */}
            <section className="bg-indigo-600 rounded-3xl text-white text-center py-16 mb-20 mx-4 sm:mx-0">
